                    ...
                    if(isEmailValid(email)) {
                        if(password.length()>=8 && password.length()<=20) {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    "Please enter minimum 8 characters as password", Toast.LENGTH_LONG)
                                    .show();
                        }
                    }
                    else if(email.matches("^[789]\\d{9}$")) {
                        if(password.length()>=8 && password.length()<=20) {
                        checkLogin(email, password);
                    }else{
                            Toast.makeText(getApplicationContext(),
                        ...
                        Toast.makeText(getApplicationContext(),
                                "Please enter email/mobile number correctly", Toast.LENGTH_LONG)
                                .show();
                    }
                } else {
